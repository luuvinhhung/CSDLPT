...
Public Class rpt_DSSV_1LOP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUANLYDIEMSV.rpt_DSSV_1LOP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DSSV_1LOP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DSSV_1LOP = New rpt_DSSV_1LOP
        rpt.Site = Me.Site
        Return rpt
    End Function
