...
Public Class rpt_DSSVLOP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUANLYDIEMSV.rpt_DSSVLOP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TENLOP() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tienchu() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_DSSVLOP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DSSVLOP = New rpt_DSSVLOP
        rpt.Site = Me.Site
        Return rpt
    End Function
