...
Public Class rpt_DSSV_new
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUANLYDIEMSV.rpt_DSSV_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DSSV_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DSSV_new = New rpt_DSSV_new
        rpt.Site = Me.Site
        Return rpt
    End Function
