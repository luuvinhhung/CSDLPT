...
Public Class rpt_DSLOP_1KHOA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUANLYDIEMSV.rpt_DSLOP_1KHOA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_makhoa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_DSLOP_1KHOA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DSLOP_1KHOA = New rpt_DSLOP_1KHOA
        rpt.Site = Me.Site
        Return rpt
    End Function
